...
function queueImageResizing({ file, args = {}, reporter }) {
  ...
  const prefixedSrc =
    options.pathPrefix + `/static/${digestDirPrefix}` + encodedImgSrc // Create job and add it to the queue, the queue will be processed inside gatsby-node.js
...
async function fluid({ file, args = {}, reporter, cache }) {
  ...
  const { width, height, density, format } = metadata // if no maxWidth is passed, we need to resize the image based on the passed maxHeight
