...
// }
// const processQueue = (store, actions, options) => {
//   const cachedQueue = getQueueFromCache(store)
//   const promises = []
//   for (const [, job] of cachedQueue) {
//     promises.push(scheduleJob(job, actions, options))
//   }
//   return promises
// }
...
//     promises.push(scheduleJob(job, actions, normalizedOptions))
//   }
//   return promises
//   // // Save queue
...
//   //   return
//   // }
//   // const imageJobs = processQueue(store, actions, normalizedOptions)
 ...
 */
// let promises = []
// exports.onPreBuild = ({ store, actions }) => {
//   promises = processQueue(store, actions, normalizedOptions)
// }
...
//     await scheduleJob(job, actions, normalizedOptions, false)
