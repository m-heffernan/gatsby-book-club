...
module.exports = async program => {
  ...
  require(`../redux/actions`).actions.setProgramStatus(`BOOTSTRAP_QUERY_RUNNING_FINISHED`);
  ...
  function printDeprecationWarnings() {
    const deprecatedApis = [`actions`, `pageContext`];
    const fixMap = {
      actions: {
        newName: `actions`,
        docsLink: `https://gatsby.dev/actions`
      },
      pageContext: {
        newName: `pageContext`,
        docsLink: `https://gatsby.dev/pageContext`
      }
    };
